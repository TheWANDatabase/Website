...
<template>
    ...
    <div class="container">
        ...
        <ul>
            <li><strong>Watch History</strong>
                <p>We will monitor and store youre playback position when you view episodes
                    through our viewer
                </p>
            </li>
            <li><strong>Statistics</strong>
                <p>We will allow you to view your watch statistics across every episode, can you
                    achieve 100% completion?
                </p>
            </li>
            <li><strong>Community Contributions</strong>
                <p>We are working very hard on bringing the ability for the
                    community to contribute to this database, to ensure that it is 100% accurate.
                </p>
            </li>
            <li><strong>Additional Features</strong>
                <p>We are always adding new features to this project, many of which are
