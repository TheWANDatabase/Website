import { castCache, profileCache, videoCache, searchCache, episodeCache, historyCache, bannerCache, integrationCache } from '~/utils/cache'
...
export default defineEventHandler(() => {
  return {
    ...
    integrations: integrationCache.getStats()
  }
})
